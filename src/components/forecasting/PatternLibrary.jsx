  ...
  return (
    <div dir="rtl" style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
        <h2 style={{ margin: 0, color: "#e2e8f0", fontSize: 17 }}>📚 ספריית דפוסים פעילים</h2>
        <button
          type="button" onClick={load}
          style={{ background: "transparent", border: "1px solid #1e3a5f", color: "#94a3b8",
      ...
      {/* Table */}
      {error && <div style={{ color: "#fca5a5", fontSize: 13 }}>שגיאה: {error}</div>}
      {loading && <div style={{ color: "#94a3b8", fontSize: 13 }}>טוען…</div>}
      ...
      {patterns.length > 0 && (
        <div style={{ overflow: "auto", maxHeight: 400 }}>
          <table style={{ width: "100%", borderCollapse: "collapse", color: "#cbd5e1", fontSize: 13 }}>
            <thead>
              <tr style={{ background: "#0a1322", color: "#94a3b8", textAlign: "right" }}>
            ...
            <tbody>
              {patterns.map(p => (
                <tr key={p.id}
                    ...
                    onMouseEnter={(e) => e.currentTarget.style.background = "#0a1322"}
      ...
      <div dir="rtl" style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <button onClick={onClose} style={{ background: "none", border: "none",
                  color: "#94a3b8", fontSize: 24, cursor: "pointer" }}>×</button>
        </div>
        <div style={{ marginTop: 12, fontSize: 13, color: "#cbd5e1", lineHeight: 1.7 }}>
          ...
          <div><strong>תנאים:</strong>
            <pre style={{ background: "#0a1322", padding: 8, borderRadius: 6,
