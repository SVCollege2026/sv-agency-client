 ...
 * Secondary nav: לוח בקרה · ניתוח · אקו-סיסטם · דוחות · יעדים
 * נטען בתוך Layout הראשי, מעביר Outlet לדפים הפנימיים
 */
...
const NAV = [
  ...
  { to: "/analytics/analysis",   icon: "⚙️",  label: "ניתוח"      },
  ...
  return (
    <div style={{ minHeight: "calc(100vh - 56px)", background: "#060d1a", direction: "rtl" }}>
      ...
      >
        ...
        {/* Back to portal button — left side */}
        <button
          type="button"
          onClick={() => navigate("/")}
          style={{
            ...
            gap:          5,
            padding:      "7px 12px",
            marginRight:  8,   /* RTL: gap from the tabs */
            fontSize:     12,
            color:        "#475569",
            background:   "none",
